...
const config: Record<UrgencyLevel, {
  ...
  CRITICAL: {
    labels: {
      ...
      "as": 'অতি জৰুৰী • পৰৱৰ্তী ৬০ মিনিটত পদক্ষেপ লওক',
      ne: 'अत्यन्त जरुरी • अर्को ६० मिनेटभित्र कदम चाल्नुहोस्',
      sd: 'تمام ضروري • ايندڙ ۶۰ منٽن ۾ قدم کڻو',
},
  ...
  HIGH: {
    labels: {
      ...
      "as": 'উচ্চ অগ্ৰাধিকাৰ • আজিয়েই পদক্ষেপ লওক',
      ne: 'उच्च प्राथमिकता • आजै कदम चाल्नुहोस्',
      sd: 'وڏي ترجيح • اڄ ئي قدم کڻو',
},
  ...
  MEDIUM: {
    labels: {
      ...
      "as": 'মধ্যম অগ্ৰাধিকাৰ • ২৪ ঘণ্টাৰ ভিতৰত জনাওক',
      ne: 'मध्यम प्राथमिकता • २४ घण्टाभित्र दर्ता गर्नुहोस्',
      sd: 'وچولي ترجيح • ۲۴ ڪلاڪن اندر داخل ڪريو',
},
