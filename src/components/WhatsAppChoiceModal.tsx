...
const WA_MODAL_I18N: Record<SupportedLanguage, {
  ...
  en: {
    ...
    evalNotice: 'The In-App Simulator provides an immediate browser sandbox of the WhatsApp triage flow. The Real WhatsApp button connects to our live host daemon bridge. Both options run on the identical GPT-4o triage and database engine.',
  ...
  hi: {
    ...
    evalNotice: 'इन-ऐप सिम्युलेटर सीधे ब्राउज़र में व्हाट्सएप ट्रायज फ्लो का तुरंत अनुभव देता है। असली व्हाट्सएप बटन लाइव गेटवे ब्रिज से कनेक्ट होता है। दोनों विकल्प एक ही GPT-4o AI इंजन और डेटाबेस का उपयोग करते हैं।',
  ...
  bn: {
    ...
    evalNotice: 'ইন-অ্যাপ সিমুলেটর সরাসরি ব্রাউজারে হোয়াটসঅ্যাপ ট্রায়াজ ফ্লোর তাত্ক্ষণিক অভিজ্ঞতা প্রদান করে। আসল হোয়াটসঅ্যাপ বোতামটি লাইভ হোস্ট গেটওয়েতে সংযোগ করে। উভয় বিকল্পই অভিন্ন GPT-4o ইঞ্জিনে চলে।',
  ...
  mr: {
    ...
    evalNotice: 'इन-अॅप सिम्युलेटर थेट ब्राउझरमध्ये व्हॉट्सअॅप ट्रायजचा त्वरित अनुभव देतो. खरा व्हॉट्सअॅप पर्याय थेट गेटवे ब्रिजशी जोडतो. दोन्ही पर्याय समान GPT-4o इंजिन वापरतात.',
  ...
  te: {
    ...
    evalNotice: 'ఇన్-యాప్ సిమ్యులేటర్ నేరుగా బ్రౌజర్‌లో వాట్సాప్ ట్రయాజ్ ప్రవాహాన్ని అందిస్తుంది. రియల్ వాట్సాప్ బటన్ లైవ్ గేట్‌వేతో కనెక్ట్ అవుతుంది. రెండూ ఒకే GPT-4o ఇంజిన్‌ను ఉపయోగిస్తాయి.',
  ...
  ta: {
    ...
    evalNotice: 'இன்-ஆப் சிமுலேட்டர் உலாவியில் உடனடி வாட்ஸ்அப் ட்ரையாஜ் அனுபவத்தை வழங்குகிறது. உண்மையான வாட்ஸ்அப் விருப்பம் நேரடி கேட்வேயுடன் இணைகிறது. இரண்டும் ஒரே GPT-4o இயந்திரத்தைப் பயன்படுத்துகின்றன.',
  ...
  gu: {
    ...
    evalNotice: 'ઇન-એપ સિમ્યુલેટર બ્રાઉઝરમાં સીધો વ્હોટ્સએપ ટ્રાયાજનો અનુભવ આપે છે. વાસ્તવિક વ્હોટ્સએપ બટન લાઇવ ગેટવે સાથે જોડાય છે. બંને સમાન GPT-4o એન્જિનનો ઉપયોગ કરે છે.',
    botOnline: 'હોસ્ટ બૉટ: ઓનલાઇન',
    botStandby: 'હોસ્ટ બૉਟ: સ્ટેન્ડબાય',
  ...
  ur: {
    ...
    realTitle: 'اصلی واટ્સ ایپ ایپ میں کھولیں',
    ...
    evalNotice: 'ان-ایپ سمیلیٹر براؤزر میں واٹس ایپ ٹرائیژ کا فوری تجربہ فراہم کرتا ہے۔ اصلی واٹس ایپ بٹن لائیو گیٹ وے سے جڑتا ہے۔ دونوں ایک ہی GPT-4o انجن استعمال کرتے ہیں۔',
  ...
  kn: {
    ...
    evalNotice: 'ಇನ್-ಆಪ್ ಸಿಮ್ಯುಲೇಟರ್ ಬ್ರೌಸರ್‌ನಲ್ಲಿ ನೇರ ವಾಟ್ಸಾಪ್ ಟ್ರಯಾಜ್ ಅನುಭವವನ್ನು ನೀಡುತ್ತದೆ. ನಿಜವಾದ ವಾಟ್ಸಾಪ್ ಬಟನ್ ಲೈವ್ ಗೇಟ್‌ವೇಗೆ ಸಂಪರ್ಕಿಸುತ್ತದೆ. ಎರಡೂ ಒಂದೇ GPT-4o ಎಂಜಿನ್ ಬಳಸುತ್ತವೆ.',
  ...
  or: {
    ...
    evalNotice: 'ଇନ୍-ଆପ୍ ସିମୁଲେଟର୍ ବ୍ରାଉଜର୍‌ରେ ତୁରନ୍ତ ହ୍ୱାଟ୍ସଆପ୍ ଟ୍ରାଇଜ୍ ଅନୁଭୂତି ଦିଏ। ପ୍ରକୃତ ହ୍ୱାଟ୍ସଆପ୍ ବଟନ୍ ଲାଇଭ୍ ଗେଟୱେ ସହିତ ସଂଯୋଗ କରେ। ଉଭୟ ସମାନ GPT-4o ଇଞ୍ଜିନ୍ ବ୍ୟବହାର କରେ।',
  ...
  ml: {
    ...
    evalNotice: 'ഇൻ-ആപ്പ് സിമുലേറ്റർ ബ്രൗസറിൽ ഉടനടി വാട്ട്‌സ്ആപ്പ് ട്രയേജ് അനുഭവം നൽകുന്നു. യഥാർത്ഥ വാട്ട്‌സ്ആപ്പ് ബട്ടൺ ലൈവ് ഗേറ്റ്‌വേയിലേക്ക് ബന്ധിപ്പിക്കുന്നു. രണ്ടും ഒരേ GPT-4o എഞ്ചിനാണ് ഉപയോഗിക്കുന്നത്.',
  ...
  pa: {
    ...
    evalNotice: 'ਇਨ-ਐਪ ਸਿਮੂਲੇਟਰ ਬ੍ਰਾਊਜ਼ਰ ਵਿੱਚ ਤੁਰੰਤ ਵਟਸਐਪ ਟ੍ਰਾਇਜ ਦਾ ਅਨੁਭਵ ਪ੍ਰਦਾਨ ਕਰਦਾ ਹੈ। ਅਸਲ ਵਟਸਐਪ ਬਟਨ ਲਾਈਵ ਗੇਟਵੇ ਨਾਲ ਜੁੜਦਾ ਹੈ। ਦੋਵੇਂ ਇੱਕੋ GPT-4o ਇੰਜਣ ਦੀ ਵਰਤੋਂ ਕਰਦੇ ਹਨ।',
