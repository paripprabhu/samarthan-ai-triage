...
const FILE_REPORT_I18N: Record<string, {
  ...
  "as": {
    eyebrow: 'আৰম্ভ কৰক',
    title: 'আপুনি কেনেকৈ অভিযোগ জনাব বিচাৰে?',
    pickCategory: 'বা এটা শ্ৰেণী বাছক',
    tabCall: '1930-লৈ কল কৰক',
    tabWhatsApp: 'WhatsApp',
    tabWeb: 'ৱেব ব্যৱহাৰ কৰক',
    callHeading: 'ৰাষ্ট্ৰীয় চাইবাৰ অপৰাধ হেল্পলাইন',
    callDesc: 'আপোনাৰ পছন্দৰ ভাষাত কথা কওক। ধন পঠোৱা হলে সহায় বিচৰাৰ এইটো আটাইতকৈ দ্ৰুত উপায়।',
    waHeading: 'Samarthan WhatsApp ডেমো',
    waDesc: 'এই এপত ভইচ নোট, বাৰ্তা বা স্ক্ৰিনশ্বট চেষ্টা কৰক।',
    waBtn: 'WhatsApp ডেমো খোলক',
    waActive: 'এপৰ ভিতৰৰ ডেমো',
  },
  ne: {
    eyebrow: 'सुरु गर्नुहोस्',
    title: 'तपाईं कसरी उजुरी दिन चाहनुहुन्छ?',
    pickCategory: 'वा एउटा वर्ग छान्नुहोस्',
    tabCall: '१९३० मा फोन गर्नुहोस्',
    tabWhatsApp: 'WhatsApp',
    tabWeb: 'वेब प्रयोग गर्नुहोस्',
    callHeading: 'राष्ट्रिय साइबर अपराध हेल्पलाइन',
    callDesc: 'आफ्नो रोजाइको भाषामा बोल्नुहोस्। पैसा पठाउनुभएको छ भने मद्दत माग्ने यो सबैभन्दा छिटो बाटो हो।',
    waHeading: 'Samarthan WhatsApp डेमो',
    waDesc: 'यस एपमा भ्वाइस नोट, सन्देश वा स्क्रिनसट प्रयोग गरेर हेर्नुहोस्।',
    waBtn: 'WhatsApp डेमो खोल्नुहोस्',
    waActive: 'एपभित्रको डेमो',
  },
  sd: {
    eyebrow: 'شروع ڪريو',
    title: 'توهان ڪيئن رپورٽ ڪرڻ چاهيو ٿا؟',
    pickCategory: 'يا هڪ قسم چونڊيو',
    tabCall: '1930 تي ڪال ڪريو',
    tabWhatsApp: 'WhatsApp',
    tabWeb: 'ويب استعمال ڪريو',
    callHeading: 'قومي سائبر ڪرائم هيلپ لائن',
    callDesc: 'پنهنجي پسند جي ٻوليءَ ۾ ڳالهايو۔ جيڪڏهن پئسا موڪليا ويا آهن ته مدد وٺڻ جو هي تيز ترين رستو آهي۔',
    waHeading: 'Samarthan WhatsApp ڊيمو',
    waDesc: 'هن ايپ ۾ وائس نوٽ، پيغام يا اسڪرين شاٽ آزمائو۔',
    waBtn: 'WhatsApp ڊيمو کوليو',
    waActive: 'ايپ اندر ڊيمو',
  },
}
