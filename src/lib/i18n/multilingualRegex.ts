...
export function extractMultilingualAmount(text: string): number {
  ...
  const vernacularThousandMap: Record<string, number> = {
    ...
    'ആയിരം': 1000, 'രണ്ടായിരം': 2000, 'മൂവായിരം': 3000, 'നാലായിരം': 4000, 'അയ്യായിരം': 5000,
    'ആറായിരം': 6000, 'ഏഴായിരം': 7000, 'എട്ടായിരം': 8000, 'ഒമ്പതിനായിരം': 9000,
    'പതിനായിരം': 10000, 'പതിനയ്യായിരം': 15000, 'പതിനഞ്ചായിരം': 15000,
    'ഇരുപതിനായിരം': 20000, 'ഇരുപത്തയ്യായിരം': 25000, 'ഇരുപത്തഞ്ചായിരം': 25000,
    'മുപ്പതിനായിരം': 30000, 'മുപ്പത്തഞ്ചായിരം': 35000,
    'നാല്പതിനായിരം': 40000, 'നാല്പത്തഞ്ചായിരം': 45000,
    'അമ്പതിനായിരം': 50000, 'അറുപതിനായിരം': 60000, 'എഴുപതിനായിരം': 70000,
    'എഴുപത്തയ്യായിരം': 75000, 'എൺപതിനായിരം': 80000, 'തൊണ്ണൂറായിരം': 90000,
    // Tamil compound thousands
    'பத்தாயிரம்': 10000, 'பதினைந்தாயிரம்': 15000, 'இருபதாயிரம்': 20000, 'இருபத்தைந்தாயிரம்': 25000,
    'முப்பதாயிரம்': 30000, 'நாற்பதாயிரம்': 40000,
    'ஐம்பதாயிரம்': 50000, 'அறுபதாயிரம்': 60000, 'எழுபதாயிரம்': 70000, 'எண்பதாயிரம்': 80000, 'தொண்ணூறாயிரம்': 90000,
    // Telugu compound thousands
    'పదిహేను వేలు': 15000, 'ఇరవై ఐదు వేలు': 25000,
  ...
  for (const w of sortedThousandKeys) {
    ...
    if (normalized.includes(w)) {
      if (/^(?:ആയിരം|രണ്ടായിരം|മൂവായിരം|നാലായിരം|അയ്യായിരം|ആറായിരം|ഏഴായിരം|എട്ടായിരം|ഒമ്പതിനായിരം|പതിനായിരം|പതിനയ്യായിരം|പതിനഞ്ചായിരം|ഇരുപതിനായിരം|ഇരുപത്തയ്യായിരം|ഇരുപത്തഞ്ചായിരം|മുപ്പതിനായിരം|മുപ്പത്തഞ്ചായിരം|നാല്പതിനായിരം|നാല്പത്തഞ്ചായിരം|അമ്പതിനായിരം|അറുപതിനായിരം|എഴുപതിനായിരം|എഴുപത്തയ്യായിരം|എൺപതിനായിരം|തൊണ്ണൂറായിരം|பத்தாயிரம்|பதினைந்தாயிரம்|இருபதாயிரம்|இருபத்தைந்தாயிரம்|முப்பதாயிரம்|நாற்பதாயிரம்|ஐம்பதாயிரம்|அறுபதாயிரம்|எழுபதாயிரம்|எண்பதாயிரம்|தொண்ணூறாயிரம்|పదిహేను వేలు|ఇరవై ఐదు వేలు)$/.test(w)) {
        return val
      }
